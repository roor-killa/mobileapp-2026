...
const String _androidUrl = 'http://localhost:8001/api';      // ← appareil physique via `adb reverse`
// const String _androidUrl = 'http://10.0.2.2:8001/api';      // ← émulateur QEMU standard
// const String _androidUrl = 'http://172.26.159.22:8001/api';   // ← IP LAN du Mac (même WiFi)
