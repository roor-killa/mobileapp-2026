# Architecture — MoneyTransferApp

## Vue d'ensemble

MoneyTransferApp suit une architecture **client-serveur mobile** avec séparation claire des responsabilités entre le frontend Flutter et le backend Laravel.
